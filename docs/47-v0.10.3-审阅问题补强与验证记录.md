...
最终清理后的分支 HEAD：`9fdbd30253e8fe01c507055351974c9fc660414f`。

GitHub Actions `Firmware quality gates #118`：`completed / success`。

- Architecture：PASS
- Code style：PASS
- UTF-8 / mojibake：PASS
- Python contract：29 tests PASS
- GCC strict build：3/3 CTest PASS
- Clang strict build：3/3 CTest PASS
- Clang AddressSanitizer + UBSan：3/3 CTest PASS
- Cortex-M0+ target syntax：12 files PASS
