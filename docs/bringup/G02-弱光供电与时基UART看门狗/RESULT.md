...
## 12. 实板时基证据（2026-09-07）

| 项 | 结果 |
|---|---|
| 时钟 | HSI 64 MHz |
| 探针 | LED_RUN 输出 500 Hz 方波（与 1 ms 节拍翻转一致） |
| 判定 | **G2-B 时基腿通过** |

## 13. 弱光与看门狗（2026-09-07 晚间）

| 项 | 结果 |
|---|---|
| G2-A 弱光 / PVD 供电资格 | **台架完成**（战役确认弱光测试通过） |
| G2-D 看门狗 | **台架完成**（战役确认 IWDT 测试通过） |
| 判定 | 弱光 + WDG 主腿 **通过** |

整门归档仍可保持 `IN_PROGRESS`（UART 10^6、正式 2 h 无误复位可后置）。总表：`docs/bringup/G0-G8-实板进度总表.md`。
