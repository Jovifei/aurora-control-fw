...
1. 先读 `docs/README.md`、`docs/GUIDE.md`、`docs/17-参数标定与Codex交接清单.md`、`docs/07-保护PWM与看门狗安全设计.md`、`docs/18-v0.7.2目录规范与交接说明.md`、`docs/19-编译修复提交2740523审计.md`，然后阅读 `docs/22`~`docs/27` 的v0.8.0迁移资料。
...
13. 修改参数前查 `docs/17`、`docs/22`、`docs/23` 和 `docs/26`，记录旧值、新值、单位、依据、测试和回退值；不得在函数体内新增魔法控制数。
